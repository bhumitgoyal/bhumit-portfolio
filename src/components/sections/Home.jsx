...
export const Home = () => {
    return <section id="home" className="min-h-screen flex items-center justify-center relative">
       ...
       <div className="text-center z-10 px-4">
        ...
        Hey there! I’m Bhumit Goyal, a passionate developer exploring AI, cloud tech, and full-stack development. Whether it’s building innovative apps, crafting AI solutions, or solving real-world problems, I love turning ideas into reality.
        </p>
   ...
   className="border border-blue-500/50 text-blue-500 py-3 px-6 rounded font-medium transition-all duration-200 
              hover:shadow-[0_0_15px_rgba(59,130,246,0.4)] hover:bg-blue-500 hover:text-white">
    Contact Me
</a>
